        ...
        onVerticalDragUpdate: (details) {
          if (PlayerPreferences.instance.flag("gestures")) {
            music.player.setVolume(
              (music.player.volume - details.delta.dy / 300).clamp(0, 1),
            );
          }
        },
        child: SafeArea(
          child: StreamBuilder<int?>(
            ...
            builder: (context, _) {
              ...
              if (item == null)
                return const Center(child: AppText('Çalan müzik yok'));
              return Padding(
                  ...
                  children: [
                    ...
                    StreamBuilder<Duration>(
                      ...
                      builder: (context, posSnapshot) {
                        final position =
                            posSnapshot.data ?? music.player.position;
                        ...
                        return Column(
                          children: [
                            Slider(
                              ...
                              onChanged: (v) =>
                                  music.seek(Duration(milliseconds: v.round())),
                            ),
                            Row(
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          onPressed: () => _seekRelative(music, -10),
                        ...
                        StreamBuilder<bool>(
                          ...
                          builder: (context, snapshot) {
                            final playing =
                                snapshot.data ?? music.player.playing;
                            return FilledButton(
